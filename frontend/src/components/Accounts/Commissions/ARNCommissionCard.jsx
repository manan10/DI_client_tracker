    ...
    >
      ...
      <div className="flex flex-col gap-3 relative z-10">
        ...
        <div className="flex items-center gap-3">
          <div className={`shrink-0 p-2.5 rounded-xl transition-all duration-500 
            ${isActive 
              ...
              : 'bg-emerald-50 dark:bg-slate-700 text-emerald-700 dark:text-emerald-500 group-hover:bg-emerald-500 group-hover:text-white group-hover:rotate-6'
            }`}
          >
            <Landmark size={18} />
          </div>
          <div className="flex-1 min-w-0 pr-6">
            ...
            <p className={`text-base font-[1000] italic leading-tight truncate transition-colors duration-300
              ${isActive ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-950 dark:text-white'}`}>
              {arn.nickname}
            </p>
          </div>
        </div>
        ...
        <div className={`flex items-end justify-between pt-3 border-t transition-colors duration-500
          ${isActive ? 'border-emerald-200/50 dark:border-emerald-800/30' : 'border-slate-50 dark:border-slate-800/50'}`}>
        ...
        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl border
          ${isActive ? 'bg-emerald-100/50 dark:bg-emerald-950/20 border-emerald-200/50' : 'bg-slate-50/50 dark:bg-slate-900/30 border-slate-100 dark:border-slate-800/50'}`}>
            ...
            <p className={`text-[11px] font-[1000] italic ${isActive ? 'text-emerald-700 dark:text-emerald-400' : 'text-emerald-600 dark:text-emerald-500'}`}>
      ...
      <div className={`absolute bottom-0 left-0 right-0 h-1 transition-all duration-700
        ${isActive ? 'bg-emerald-500 scale-x-100 opacity-100' : 'bg-emerald-500 scale-x-0 opacity-0 group-hover:scale-x-75 group-hover:opacity-30'}`} 
      />
    </button>
  );
};
