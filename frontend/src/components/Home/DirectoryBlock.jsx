  ...
  return (
    <div 
      ...
      className="group relative overflow-hidden cursor-pointer transition-all duration-300
                 ...
                 rounded-2xl lg:rounded-[2.5rem] p-6 lg:p-12
    ...
    >
      ...
      <div className="absolute -right-8 -bottom-8 text-slate-100 dark:text-white/2 transition-transform duration-700 group-hover:scale-110 group-hover:-rotate-12">
        <Database size={160} lg:size={240} strokeWidth={1} />
      </div>
      
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 lg:gap-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 lg:gap-6">
          {/* ICON WELL */}
          <div className="w-12 h-12 lg:w-16 lg:h-16 bg-emerald-600 dark:bg-emerald-500 rounded-xl lg:rounded-2xl flex items-center justify-center text-white shadow-xl shadow-emerald-500/20 group-hover:rotate-6 transition-transform">
            <Users size={24} lg:size={32} strokeWidth={2.5} />
          </div>
          
          <div className="space-y-1 lg:space-y-2">
            <div className="flex items-center gap-3">
              <h3 className="text-xl lg:text-3xl font-[1000] text-slate-950 dark:text-white uppercase tracking-tighter leading-none">
                Master Directory
              </h3>
            ...
            <p className="text-[11px] lg:text-sm font-medium text-slate-500 dark:text-slate-400 max-w-lg leading-relaxed">
        ...
        {/* CALL TO ACTION */}
        <div className="flex items-center justify-center gap-4 py-3 px-5 lg:py-4 lg:px-6 bg-slate-50 dark:bg-white/5 border-2 border-slate-100 dark:border-white/5 rounded-xl lg:rounded-2xl 
                        text-slate-900 dark:text-white font-[1000] text-[10px] lg:text-[11px] uppercase tracking-[0.2em] 
