...
const MasterRow = ({ parent, isActive, onSelect, isSelectionMode, isSelected, toggleSelection, isSearchActive }) => {
  ...
  return (
    <div 
      ...
      style={{
        background: isActive && !isSelectionMode ? `linear-gradient(90deg, ${hexToRgba(parent.color, 0.15)} 0%, transparent 100%)` : '',
        boxShadow: isActive && !isSelectionMode ? `-4px 4px 15px -5px ${hexToRgba(parent.color, 0.4)}` : '',
      }}
    >
      <div 
