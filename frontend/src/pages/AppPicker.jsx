      ...
      <div className="relative z-10 flex flex-col h-full p-5 sm:p-10 lg:p-16">
        ...
        <div className="mb-8 sm:mb-12">
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-[1000] text-slate-900 tracking-tighter uppercase italic leading-[0.9]">
            Welcome <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-500 to-indigo-600">{user?.name?.split(' ')[0] || 'Manan'}.</span>
          </h1>
        ...
        <div className="flex-1 flex flex-col sm:flex-row gap-4 sm:gap-6 min-h-0 mb-4">
          {apps.map((app) => (
            ...
            >
              ...
              <div className="absolute -bottom-4 -right-2 text-8xl font-black text-slate-50 italic pointer-events-none leading-none select-none transition-transform group-hover:scale-110 duration-700">
                {app.id === 'client-tracker' ? '01' : '02'}
              </div>
            </button>
          ))}
        </div>
        ...
        <div className="flex justify-between items-center opacity-30 pt-2">
           <div className="flex items-center gap-4">
              ...
              <p className="text-[8px] font-black text-slate-900 uppercase tracking-[0.5em]">System_Live_v4.0</p>
           </div>
           <p className="text-[8px] font-black text-slate-900 uppercase tracking-widest italic">Dalal Family Hub</p>
        </div>
      </div>
    </div>
  );
