...
import ARNTransferMailer from "../../components/Operations/ARNTransferMailer";
...
const Operations = () => {
  ...
  const tabs = [
    ...
    // { id: "mailer", name: "ARN Transfer", icon: Mail, isLocked: true },
  ];
    ...
    <div className="min-h-screen bg-[#FDFDFD] dark:bg-slate-950 transition-colors duration-300">
      ...
      <main className="max-w-400 mx-auto px-5 md:px-12 lg:px-20 pt-8 md:pt-16 pb-32 md:pb-20 w-full">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
          ...
          {activeTab === "mailer" && <ARNTransferMailer />}
        </div>
      </main>
    </div>
  );
