...
import WalletActionModal from "../../components/ExpenseTracker/Dashboard/WalletActionModal";
import WalletGridSection from "../../components/ExpenseTracker/Dashboard/WalletGridSection";
import TransactionLedger from "../../components/ExpenseTracker/Dashboard/TransactionLedger";
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pb-6 border-b border-slate-200/80 dark:border-white/10 shrink-0">
          ...
          <div className="flex flex-col items-start md:items-end gap-1 w-full md:w-auto shrink-0">
            <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
              <Activity size={14} strokeWidth={2.5} className="text-emerald-500" />
