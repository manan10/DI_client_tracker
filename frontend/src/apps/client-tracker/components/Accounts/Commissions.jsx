...
const Commissions = () => {
  ...
  const isLastYear =
    availableYears.indexOf(selectedFY) === availableYears.length - 1;
    ...
    <div className="w-full space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-2">
        <div className="flex flex-col gap-2 min-w-0">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
            Reconcile mutual fund brokerage, inspect entity metrics, and log
            monthly entries.
          </p>
        </div>
            ...
            {selectedARN ? (
                  ...
                  <div className="flex items-center gap-3.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-slate-400 dark:text-slate-500 font-medium mt-0.5">
                        Performance analytics and monthly commission history for
                        FY {selectedFY}
                      </p>
                    </div>
                  </div>
              ...
              <div className="p-12 border border-dashed border-slate-200 dark:border-white/10 rounded-xl text-center">
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Please select an ARN tab above to inspect its metrics.
                </p>
              </div>
            )}
          </section>
      ...
      {selectedARN && (
        <CommissionForm
          ...
          arnId={selectedARN.id}
          amcList={
            arns.find((a) => a._id === selectedARN.id)?.allowedAmcs || []
          }
