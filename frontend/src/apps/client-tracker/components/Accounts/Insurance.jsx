...
const Insurance = () => {
  ...
  const getPolicyCategoryIcon = (type) => {
    ...
    if (type.startsWith("HEALTH"))
      return <HeartPulse size={15} className="text-teal-500" />;
    if (type.startsWith("MOTOR"))
        ...
        {loading ? (
          ...
          <div className="py-20 text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Add your policies or adjust your filters.
            </p>
          </div>
        ) : (
                          ...
                          <div className="flex flex-col text-[11px]">
                            {p.investmentDetails?.unitsHeld > 0 && (
                              <span className="font-mono text-slate-700 dark:text-slate-300">
                                {p.investmentDetails.unitsHeld} Units @ ₹
                                {p.investmentDetails.latestNav || 0}
                              </span>
                            )}
                            <span className="text-[9px] font-bold text-indigo-600 dark:text-indigo-400 uppercase">
                              Invested:{" "}
                              {formatCurrency(
                                p.investmentDetails?.totalInvestedTillDate,
                              )}
                            </span>
                          </div>
                        )}
                        ...
                        {isInvestmentPolicy ? (
                          <div className="flex flex-col">
                            <span className="font-black text-indigo-600 dark:text-indigo-400 text-sm">
                              {formatCurrency(
                                p.investmentDetails?.currentValuation ||
                                  p.sumAssured,
                              )}
                            </span>
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] font-bold uppercase tracking-wider text-slate-400">
                            {p.premiumFrequency.replace(/_/g, " ")} • PPT:{" "}
                            {p.premiumPayingTermYears || 1}y
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-1.5">
                          <Calendar
                            size={13}
                            className={
                              isDueSoon ? "text-amber-500" : "text-slate-400"
                            }
                          />
                          <span
                            className={`font-bold ${
