...
import Navbar from "../components/Shared/Navbar"; // Adjust the path to your Navbar location
        ...
        <div className="max-w-xl w-full text-center space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-md mx-auto">
              We are currently optimizing the Document Vault for the production
              environment. The module is temporarily locked to ensure 100% data
